class Footer extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = ` <
                section id = "footer"
            class = "s-button2 w-full flex justify-between items-center mb-5" >
                <
                div class = "mr-12" >
                <
                img src = "/assets/images/footer/hirad-Logo 1.png"
            alt = "" / >
                <
                /div>
            ...
            div class = "grid grid-cols-3 grid-rows-3 gap-8" >
                ...
                <
                img src = "./assets/images/footer/arrow-left.svg"
            alt = "" / >
                <
                a href = "/" > خانه < /a> <
                /div> <
            ...
            alt = "" / >
                ...
                div class = "flex justify-start items-center gap-1.5" >
                <
                img src = "./assets/images/footer/call-calling.svg"
            alt = "" / >
                <
                ...
                div class = "flex justify-start items-center gap-1.5" >
                <
                img src = "./assets/images/footer/whatsapp.svg"
            alt = "" / >
                <
                ...
                div class = "flex justify-start items-center gap-1.5" >
                <
                img src = "./assets/images/footer/sms.svg"
            alt = "" / >
                <
