const server = {
  hero_image: { id: 0, image_url: "https://example.com/zero-image.jpg", caption: "Zero ID caption", title: "Zero ID title" },
  services: [
    { id: 1, icon: "web_icon.png", name: "Web Development", description: "Building modern, responsive websites." },
    { id: 2, icon: "web_icon.png", name: "Web Development", description: "Building modern, responsive websites." },
    { id: 3, icon: "web_icon.png", name: "Web Development", description: "Building modern, responsive websites." },
    { id: 4, icon: "web_icon.png", name: "Web Development", description: "Building modern, responsive websites." },
  ],
  about: { id: 0, title: "About Our Company", content: "We are a leading provider of innovative solutions...", link: "" },
  statistics: [
